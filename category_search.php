                ...
                <main>
                    ...
                    <?php 
                        if(isset($_POST['search-keyword'])) {
                            $url = "http://localhost/PDO/kutyTech/category_search.php?key=".$_POST['search-keyword']."&cat_id=".$_POST['category-id'];
                            header("Location: {$url}");
                        }
                    ?>
                                                ...
                                                <a class="card post-preview lift h-100" href="single.php?post_id=<?php echo $post_id; ?>"
                                                    ...
                                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                                        <div class="post-preview-meta">
                                                            <img class="post-preview-meta-img" src="./img/mdabarik.PNG" />

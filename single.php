            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                        <div class="container">
                        <a class="navbar-brand text-dark" href="index.php"><img src="img/kutytech.jpg" style="height:40px;width:150px" /></a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><img src="img/kutytech.jpg" style="height:20px;width:25px" /><i data-feather="menu"></i></button>
                    ...
                    <?php
                        ...
                        if(isset($_GET['post_id'])) {
                            ...
                            $sql = "SELECT * FROM posts WHERE post_id = :id AND post_status = :status";
                            ...
                            <div class="container text-center">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                        ...
                                        <p class="page-header-text"><?php echo $post_date; echo "  " ;echo $post_category; ?>,
                    ...
                    <section class="bg-white py-10">
                        <div class="container">
                            <!--start post content-->
                            <div>
                                <h1><strong><?php echo $post_title; ?></strong></h1>
                            ...
                            <div class="pt-5 col-lg-8 col-xl-9">
                                ...
                                <?php 
                                   ...
                                   <?php } else {
                                        echo "<a href='./backend/sign-in.php'>Sign in to comment</a>";
                                   }
                                ?>
                ...
                <footer class="footer pt-4 pb-4 mt-auto bg-dark footer-dark">
                    <div class="container">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 small">Copyright &#xA9; kutyTech, 2024</div>
